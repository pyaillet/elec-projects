...
function componentToString(obj) {
  ...
  if (obj.type !== null) str += obj.type;
  if (obj.model !== null) str += " " + obj.model;
  if (obj.subtype !== null) str += " " + obj.subtype;
  try {
    let qualifiedValue = math.unit(obj.value+" "+obj.unit);
    str += " " + math.format(qualifiedValue, 4);
  }
  catch(e) {
    if (obj.value !== null) str += " " + obj.value;
    if (obj.unit !== null) str+= " " + obj.unit;
  }
  if (obj.stock !== null) str += "\t\t\tstock: " + obj.stock;
  return str;
}
